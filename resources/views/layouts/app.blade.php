...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('SPK-Pohon Gaharu') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/img/link-head.png">
    <link rel="icon" type="image/png" href="{{ asset('material') }}/img/link-head.png">
