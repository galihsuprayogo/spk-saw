  ...
  <div class="row align-items-center">
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3" style="margin-top: 30%">
          <div class="card-header card-header-primary text-center">
            <p/>
            <p class="card-description text-center">{{ __('Silahkan masuk dengan ') }} <strong> Email </strong> {{ __('dan') }}<strong> Kata Sandi </strong> </p>
          </div>
          <div class="card-body">
